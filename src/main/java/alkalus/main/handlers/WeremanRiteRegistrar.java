...
/**
 * Registers the Rite of the Wereman into RiteRegistry. Runs in postInit so Witchery's own
 * rites (IDs 1-96) exist first; ours takes ID 100 and bookIndex 50 (end of the book).
 * The Circle Magic book renders every registered rite automatically.
 */
public class WeremanRiteRegistrar {
    ...
    public void register(FMLPostInitializationEvent event) {
        RiteRegistry.addRecipe(
            ...
            new SacrificeMultiple(new Sacrifice[] {
                new SacrificeItem(new ItemStack[] {
            ...
            new com.emoniph.witchery.ritual.Circle(0, 0, 28))
            .setUnlocalizedName("witchery.rite.wereman");
    }
}
